package com.cloude.xmut.animation;
...
public class DayNightLoadingRenderer extends LoadingRenderer {
    ...
    private static final int DEFAULT_COLOR = Color.parseColor("#00FF00");  //部件颜色
   // private static final int MoonNight_COLOR = Color.parseColor("#FFD700");
