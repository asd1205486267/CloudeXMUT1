 ...
 */
package cn.bingoogolapple1.photopicker.activity;
...
import cn.bingoogolapple1.photopicker.adapter.BGAPhotoPickerAdapter;
import cn.bingoogolapple1.photopicker.imageloader.BGARVOnScrollListener;
import cn.bingoogolapple1.photopicker.model.BGAPhotoFolderModel;
import cn.bingoogolapple1.photopicker.pw.BGAPhotoFolderPw;
import cn.bingoogolapple1.photopicker.util.BGAAsyncTask;
import cn.bingoogolapple1.photopicker.util.BGALoadPhotoTask;
import cn.bingoogolapple1.photopicker.util.BGAPhotoHelper;
...
public class BGAPhotoPickerActivity extends BGAPPToolbarActivity implements BGAOnItemChildClickListener, BGAAsyncTask.Callback<ArrayList<BGAPhotoFolderModel>> {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_CODE_TAKE_PHOTO) {
                ...
                Intent photoPickerPreview = new cn.bingoogolapple1.photopicker.activity.BGAPhotoPickerPreviewActivity.IntentBuilder(this)
                ...
                if (cn.bingoogolapple1.photopicker.activity.BGAPhotoPickerPreviewActivity.getIsFromTakePhoto(data)) {
                    // 从拍照预览界面返回，刷新图库
                    mPhotoHelper.refreshGallery();
                }

                returnSelectedPhotos(cn.bingoogolapple1.photopicker.activity.BGAPhotoPickerPreviewActivity.getSelectedPhotos(data));
            }
            ...
            if (cn.bingoogolapple1.photopicker.activity.BGAPhotoPickerPreviewActivity.getIsFromTakePhoto(data)) {
                ...
                mPicAdapter.setSelectedPhotos(cn.bingoogolapple1.photopicker.activity.BGAPhotoPickerPreviewActivity.getSelectedPhotos(data));
                renderTopRightBtn();
            }
        }
    }
    ...
    private void changeToPreview(int position) {
        ...
        Intent photoPickerPreviewIntent = new cn.bingoogolapple1.photopicker.activity.BGAPhotoPickerPreviewActivity.IntentBuilder(this)
